...
PanelGadget(#panel, 5, ToolBarHeight(0), WindowWidth(0) - 10, WindowHeight(0) - 10 - ToolBarHeight(0))
AddGadgetItem (#panel, -1, "Tab1")
;editor = PBEdit_Gadget(0,0,0,0,0)
editor = PBEdit_Gadget(0,0,0,GetGadgetAttribute(#panel, #PB_Panel_ItemWidth),GetGadgetAttribute(#panel, #PB_Panel_ItemHeight))
CloseGadgetList()
